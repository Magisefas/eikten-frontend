    ...
    <div className="flex flex-col flex-1 items-center justify-center p-6 bg-[#0f0f0f]">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <div className="text-sm text-[#555]">Sukurk naują paskyrą</div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div>
            <label className="text-[10px] text-[#555] font-semibold uppercase tracking-wider block mb-2">Vardas</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="text-[10px] text-[#555] font-semibold uppercase tracking-wider block mb-2">Pakartok slaptažodį</label>
            <input
              type="password"
              value={passwordConf}
        ...
        <div className="text-center mt-6 text-sm text-[#555]">
          Jau turi paskyrą?{' '}
          <Link to="/login" className="text-[#4ade80] hover:opacity-80">
            Prisijungti
          </Link>
        </div>
